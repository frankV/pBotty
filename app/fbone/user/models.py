...
class User(db.Model, UserMixin):
    ...
    oauth_token = Column(db.String(STRING_LEN))
    oauth_secret = Column(db.String(STRING_LEN))

    facebook_id = Column(db.String(STRING_LEN))
    twitter_id = Column(db.String(STRING_LEN))
